...
public class TeclaBlanca2 extends TeclaBlanca {
    ...
    protected int[] getVerticesX() {
        ...
        return new int[] {x, x, x+B, x+B, x+B, x+B-N/2, x+B-N/2, x};
    }

    @Override
    protected int[] getVerticesY() {
        int y = this.posicion.y;
        return new int[] {y, y+TeclaBlanca.ALTURA, y+TeclaBlanca.ALTURA, y+TeclaNegra.ALTURA, y+TeclaNegra.ALTURA, y+TeclaNegra.ALTURA, y};
    }
}
